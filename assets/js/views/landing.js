import { el, clear, fmtScore } from "../utils.js?v=13";
import { getCurrentEdition } from "../state.js?v=13";
import { listProjects, listRanking } from "../data.js?v=13";
import { subscribeTable } from "../realtime.js?v=13";
